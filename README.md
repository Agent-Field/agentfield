...
```bash
af install https://github.com/Agent-Field/SWE-AF//go         # autonomous engineering team  → node: swe-planner-go
...
af run swe-planner-go                                        # start a node (prompts once for required secrets)
af call swe-planner-go.build --in '{"goal": "Add JWT auth", "repo_url": "https://github.com/user/my-repo"}'
```
